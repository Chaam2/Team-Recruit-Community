...
|  🧊 박지원 (백엔드 팀장, BE) | 서버 구축 <br/>  AWS RDS DataBase 구축 <br/> ERD 설계 <br/> JWT 토큰 인증 및 인가 미들웨어 <br/> multer 이미지 업로드 미들웨어 <br/> class-validator 유효성 검사 미들웨어 <br/> 카카오 로그인 API <br/> 실시간 인기 기술스택 API <br/> 유저 관련 API <br/> 프로젝트 모집 글 관련 API <br/> 포트폴리오 자랑(게시) 글 관련 API <br/> 댓글 관련 API <br/> 북마크 관련 API |
...
[API Docs](https://www.notion.so/moppe/API-Docs-ce1a1897ae0d4ca49e2b91e4766aaa1f?pvs=4)
